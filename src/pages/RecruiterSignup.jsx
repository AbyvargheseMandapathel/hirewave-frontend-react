...
const RecruiterSignup = () => {
  ...
  const handleFinalSubmit = (e) => {
    ...
    console.log('Recruiter signup data with OTP verification:', { ...formData, otp: otpValue });
    ...
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-200px)]">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0f172a] items-center justify-center p-4">
        <div className="max-w-lg">
          ...
          />
          <div className="mt-6 text-center">
            <h2 className="text-2xl font-bold text-white mb-2">Find the Perfect Candidates</h2>
            <p className="text-[#94a3b8]">
              Join our platform to connect with qualified candidates and streamline your hiring process.
            </p>
            <div className="mt-6 grid grid-cols-3 gap-4">
              <div className="bg-[#1e293b] p-4 rounded-lg">
                <h3 className="text-white font-medium mb-1">Post Jobs</h3>
                <p className="text-[#94a3b8] text-sm">Create and manage job listings</p>
              </div>
              <div className="bg-[#1e293b] p-4 rounded-lg">
                <h3 className="text-white font-medium mb-1">Screen Candidates</h3>
                <p className="text-[#94a3b8] text-sm">Review applications efficiently</p>
              </div>
              <div className="bg-[#1e293b] p-4 rounded-lg">
                <h3 className="text-white font-medium mb-1">Schedule Interviews</h3>
                <p className="text-[#94a3b8] text-sm">Manage the hiring process</p>
              </div>
              <div className="bg-[#1e293b] p-4 rounded-lg col-span-3">
                <h3 className="text-white font-medium mb-1">Analytics Dashboard</h3>
                <p className="text-[#94a3b8] text-sm">Track performance metrics and optimize your hiring process</p>
              </div>
            </div>
          </div>
        </div>
